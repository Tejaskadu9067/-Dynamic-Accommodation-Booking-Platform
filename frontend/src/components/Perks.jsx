...
export default function Perks({selected, onChange}) {
  ...
  return (
    <div className="grid gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mt-2">
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer ">
                <input type="checkbox"  checked={selected.includes('parking')} name='parking' onChange={handleCbClick} className="" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer ">
                <input type="checkbox"  checked={selected.includes('tv')} name='tv' onChange={handleCbClick} className="" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer ">
                <input type="checkbox"  checked={selected.includes('radio')} name='radio' onChange={handleCbClick} className="" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer ">
                <input type="checkbox"  checked={selected.includes('pets')} name='pets' onChange={handleCbClick} className="" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer ">
                <input type="checkbox"  checked={selected.includes('entrance')} name='entrance' onChange={handleCbClick} className="" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
